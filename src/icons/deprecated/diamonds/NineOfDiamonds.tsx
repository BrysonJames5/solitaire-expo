...
export const NineOfDiamonds = (props) => {
  return (
    <Svg
    ...
    >
      <G transform="translate(0 -719.362)">
        ...
        >
          <Path
            d="M-209.307-1021.302q0 5.99-2.125 9.742-2.66 4.708-8.19 4.708-3.235 0-5.34-1.283-2.546-1.569-2.546-4.631 0-.67.938-.67h2.833q.555 0 .937.632.574.938.88 1.205.785.632 2.297.632 2.546 0 3.962-2.373 1.11-1.914 1.244-4.708-2.24 1.78-5.359 1.78-3.961 0-6.315-2.794-2.22-2.622-2.22-6.66 0-4.25 2.43-6.718 2.43-2.488 6.66-2.488 9.914 0 9.914 13.626zm-5.225-4.306q0-2.086-1.13-3.54-1.243-1.608-3.253-1.608-2.067 0-3.291 1.57-1.11 1.435-1.11 3.578 0 2.182 1.09 3.598 1.187 1.55 3.311 1.55 2.106 0 3.292-1.569 1.091-1.416 1.091-3.579z"
            transform="scale(-.9908 -1.0093)"
            aria-label={9}
            strokeWidth={1}
          />
